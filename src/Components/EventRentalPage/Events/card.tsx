...
const places = [
  { id: 1, name: "SKYSTAR HAI BÀ TRƯNG", tel: '0824678230', image: "https://skystarimages.s3.us-east-1.amazonaws.com/c%C3%A1c+%C4%91%E1%BB%8Ba+%C4%91i%E1%BB%83m+c%E1%BB%A5m+r%E1%BA%A1p/abtQT.JPG", description: "SKYSTAR Hai Bà Trưng - 135 Hai Bà Trưng nằm tại trung tâm Quận 1, gần nhiều trường đại học, trung tâm văn hóa và thương mại. Với vị trí đắc địa này SKYSTAR Hai Bà Trưng là điểm đến giải trí ưa thích của nhiều khán giả trẻ. Với cam kết mang đến những trải nghiệm điện ảnh tuyệt vời nhất cùng giá vé hấp dẫn." },
  { id: 2, name: "SKYSTAR LÂM ĐỒNG", tel: '0288101001', image: "https://skystarimages.s3.us-east-1.amazonaws.com/c%C3%A1c+%C4%91%E1%BB%8Ba+%C4%91i%E1%BB%83m+c%E1%BB%A5m+r%E1%BA%A1p/abtL%C4%90.JPG", description: "SKYSTAR Lâm Đồng - 713 QL20, Lâm Đồng, nằm tại trung tâm của tỉnh Lâm Đồng, là điểm đến giải trí phổ biến cho cộng đồng yêu thích điện ảnh trong khu vực. Với vị trí đắc địa, rạp SKYSTAR Lâm Đồng mang đến cho cả cư dân địa phương và du khách những trải nghiệm điện ảnh độc đáo trên màn ảnh rộng." },
  { id: 3, name: "SKYSTAR ĐÀ LẠT", tel: '0969688686', image: "https://skystarimages.s3.us-east-1.amazonaws.com/c%C3%A1c+%C4%91%E1%BB%8Ba+%C4%91i%E1%BB%83m+c%E1%BB%A5m+r%E1%BA%A1p/abtDaLat.JPG", description: "SKYSTAR Đà Lạt - Quảng trường Lâm Viên, tọa lạc tại trung tâm thành phố Đà Lạt, là điểm đến giải trí lý tưởng cho cộng đồng yêu thích điện ảnh tại thành phố ngàn hoa này. Với vị trí đắc địa, SKYSTAR Đà Lạt thuận lợi cho cả cư dân địa phương và du khách thưởng thức các tác phẩm điện ảnh đa dạng trên màn ảnh rộng." },
  { id: 4, name: "SKYSTAR HUẾ", tel: '0355202002', image: "https://skystarimages.s3.us-east-1.amazonaws.com/c%C3%A1c+%C4%91%E1%BB%8Ba+%C4%91i%E1%BB%83m+c%E1%BB%A5m+r%E1%BA%A1p/abtHue.JPG", description: "SKYSTAR Huế - 25 Hai Bà Trưng, TP.Huế, nằm tại trung tâm thành phố Huế, là điểm đến giải trí phổ biến với cộng đồng yêu điện ảnh tại vùng này. Với vị trí đắc địa, rạp SKYSTAR Huế thuận lợi cho cả cư dân địa phương và du khách thưởng thức các bộ phim đa dạng trên màn ảnh rộng." },
];
    ...
    >
      ...
      <Card.Body
        ...
        style={{
          ...
          padding: hovered ? '17px' : '10px',
          justifyContent: 'center',
          flexDirection: 'column',
        }}
      >
        <p className="fs-4">{place.name}</p>
